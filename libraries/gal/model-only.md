...
| `GAL-KANZ-STAMP` | `editing.cliche_without_function` | Откуда что берется?; Мертвый хватает живого | функция формулы в жанре | термин, цитата, пародия и жанровая формула допустимы |
...
| `GAL-TERM-AUDIENCE` | `editing.term_audience_fit` | Веревка — вервие простое | кто читатель и нужен ли термин | точный термин не упрощать до неточного бытового слова |
...
| `GAL-IDIOM-CONTAMINATION` | `editing.idiom_contamination` | «Свинки замяукали» | является ли гибрид случайным | игра слов и пародия сохраняются |
