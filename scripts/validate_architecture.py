...
REQUIRED_FILES=["AGENTS.md","CONTRIBUTING.md","SKILL.md","BOARD_SKILL.md","docs/editorial-board-architecture.md","docs/evidence-provider-architecture.md","libraries/README.md","libraries/native/library.json","evidence/README.md","evidence/_template/provider.json","reviewers/native.json","styles/neutral.json","schemas/evidence-provider.schema.json","schemas/evidence-item.schema.json","scripts/check.py","scripts/lint.py","scripts/library_runtime.py","scripts/evidence_runtime.py","scripts/editorial_board.py","scripts/review.py","scripts/validate_libraries.py","scripts/benchmark_lint.py","scripts/benchmark_board.py","tests/lint_cases.json","tests/editorial_board_cases.json",".github/workflows/quality.yml"]
...
CHECK_MARKERS=["MECHANICAL_RULES","--extended","from library_runtime import compact_shape, run_libraries"]
BOARD_MARKERS=["Editorial Board mode","scripts/review.py","CONSENSUS","SOURCE_CONFLICT","Evidence"]
QUALITY_MARKERS=["python -m compileall -q scripts","python scripts/lint.py --self-test","python scripts/benchmark_lint.py","python scripts/validate_architecture.py","python scripts/validate_libraries.py","python scripts/benchmark_board.py"]
